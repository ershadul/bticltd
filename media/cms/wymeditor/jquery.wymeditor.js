...
WYMeditor.editor.prototype.bindEvents = function() {
  ...
  //handle focus/blur news to check if the element has focus, see #147
    ...
    if (this.isValidTag(tag)) {
      ...
      for(var key in default_attributes_and_events) {
        ...
        if(typeof defaults == 'object'){
          ...
          var tag_defaults = defaults['attributes'] ? defaults['attributes'] : defaults['news'];
...
/**
* This are the rules for breaking the XHTML code into news
...
* XHTML Parser.
*
* This XHTML parser will trigger the news available on on
* current SaxListener
*
*    @author Bermi Ferrer (http://bermi.org)
*/
...
WYMeditor.WymClassMozilla.prototype.initIframe = function(iframe) {
    ...
    //bind editor keydown news
    jQuery(this._doc).bind("keydown", this.keydown);
    
    //bind editor keyup news
    jQuery(this._doc).bind("keyup", this.keyup);
    
    //bind editor focus news (used to reset designmode - Gecko bug)
